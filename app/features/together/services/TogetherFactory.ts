/*@ngInject*/
export function Together(SocketIO, ENV, $resource, CurrentUser, lodash, CurrentSession, Localytics) {
  ...
  function setTogether(bookId, page, controllingUserId) {
    ...
    together.bookId = bookId || together.bookId;
    together.pageUrl = page || together.pageUrl;
