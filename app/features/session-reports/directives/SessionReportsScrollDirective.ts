/*@ngInject*/
export function SessionReportsScroll(SessionProxy, moment, SessionReportsValues, lodash, Localytics) {
  return {
    link: link,
    restrict: 'E',
    ...
    scope.loadItems = function () {
      ...
      SessionProxy.query(startDate, endDate, SessionReportsValues.reportsBulkSize, scope.classId)
        .then(function (sessions) {
          ...
          endDate = lodash(scope.sessions).chain().map(function (session:any) {
